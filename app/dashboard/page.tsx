...
const bookings = [
  { service: "Service Name", total: 2, status: "Completed" },
  { service: "Service Name", total: 1, status: "Completed" },
  { service: "Service Name", total: 1, status: "In progress" },
  { service: "Service Name", total: 2, status: "Pending" },
];
...
<div className="space-y-5">
    <h2 className="text-[24px] font-bold font-workSans text-[rgba(21,27,56,1)]">Dashboard</h2>
<Hero />
